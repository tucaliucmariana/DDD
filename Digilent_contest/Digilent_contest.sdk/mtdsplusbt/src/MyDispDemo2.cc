...
void setup() {
  ...
  ** buttons perform.
  */  
  mydisp.createButton(0, "BmpLib/led_48x48_g_on.BMP", "Images/IMG_0002.BMP",  10, 270);
  mydisp.createButton(1, "BmpLib/led_48x48_b_on.BMP", "Images/IMG_0002.BMP", 100, 270);
  mydisp.createButton(2, "BmpLib/led_48x48_r_on.BMP", "Images/IMG_0002.BMP", 190, 270);
  ...
  */  
  switch(mydisp.getButton()) {
    case 0:
      ...
      */
      EraseImageBox();
      mydisp.drawImage("BmpLib/checkbox_checked_black_on_gray.BMP", 20, 20);
      mydisp.setForeground(clrWhite);
      xil_printf("You pressed the button 'START'\r\n");
      mydisp.drawText("START", 160, 25);
      break;
    ...
    case 1:
      ...
      */
      EraseImageBox();
      mydisp.drawImage("BmpLib/back_arrow_black_on_grayy.BMP", 20, 20);
      mydisp.setForeground(clrWhite);
      xil_printf("You pressed the button 'RESET'\r\n");
      mydisp.drawText("RESET", 160, 25);
      break;
    ...
    case 2:
      ...
      */
      EraseImageBox();
      mydisp.drawImage("BmpLib/led_24x24_r_on.BMP", 20, 20);
      mydisp.setForeground(clrWhite);
      xil_printf("You pressed the button 'STOP'\r\n");
      mydisp.drawText("STOP", 160, 25);
      break;
  }
...
void EraseImageBox() {
  ...
  */  
  ...
  mydisp.drawRectangle(true, 10, 10, 230, 70);

  /* And draw a white border around it.
  */  
  mydisp.setForeground(clrWhite);
  mydisp.setPen(penSolid);
  mydisp.drawRectangle(false, 10, 10, 230, 70);
