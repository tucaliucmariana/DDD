...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=22,numReposBlks=13,numNonXlnxBlks=2,numHierBlks=9,maxHierDepth=1,da_axi4_cnt=6,da_board_cnt=2,da_mb_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (ja_pin10_i,
    ja_pin10_o,
    ja_pin10_t,
  ...
  design_1_PmodMTDS_0_0 PmodMTDS_0
       (.AXI_LITE_GPIO_araddr(microblaze_0_axi_periph_M02_AXI_ARADDR[8:0]),
        ...
        .AXI_LITE_TIMER_araddr(microblaze_0_axi_periph_M03_AXI_ARADDR[4:0]),
        ...
        .AXI_LITE_TIMER_awaddr(microblaze_0_axi_periph_M03_AXI_AWADDR[4:0]),
        ...
        .AXI_LITE_TIMER_bresp(microblaze_0_axi_periph_M03_AXI_BRESP),
        .AXI_LITE_TIMER_bvalid(microblaze_0_axi_periph_M03_AXI_BVALID),
        .AXI_LITE_TIMER_rdata(microblaze_0_axi_periph_M03_AXI_RDATA),
        .AXI_LITE_TIMER_rready(microblaze_0_axi_periph_M03_AXI_RREADY),
        .AXI_LITE_TIMER_rresp(microblaze_0_axi_periph_M03_AXI_RRESP),
        .AXI_LITE_TIMER_rvalid(microblaze_0_axi_periph_M03_AXI_RVALID),
        .AXI_LITE_TIMER_wdata(microblaze_0_axi_periph_M03_AXI_WDATA),
        .AXI_LITE_TIMER_wready(microblaze_0_axi_periph_M03_AXI_WREADY),
        .AXI_LITE_TIMER_wstrb(microblaze_0_axi_periph_M03_AXI_WSTRB),
